CLASS zcl_zscarr_entry1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_zscarr_entry1 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
  DATA:it_zscarr TYPE TABLE OF zscarr1.
...
*   insert the new table entries
    INSERT zscarr1 FROM TABLE @it_zscarr.

*   check the result
    SELECT * FROM zscarr1 INTO TABLE @it_zscarr.
    out->write( sy-dbcnt ).
